 ...
 * @autor: Abel_HZO
 * @company: AbelHZO
 * @created: 20/09/2018 18:50:38
 * @file: ViewDeposit.java
 * @license: <i>GNU General Public License<i>
 *
 */
public class ViewDeposit extends JPanel implements ActionListener, ChangeListener, KeyListener, MouseListener {

	/**
	 * 
	 */
	private static final long serialVersionUID = 7167042445741286494L;
	...
	private JButton buttonDeposit, buttonCancel;
	...
	public ViewDeposit() {
		...
		radioCombo = new JRadioButton("Seleccione una cantidad a depositar: ");
		...
		radioField = new JRadioButton("Escriba una cantidad a depositar: ");
		...
		buttonDeposit = new JButton("Depositar", new ImageIcon(getClass().getClassLoader().getResource("images/money_add_16x16.png")));
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == buttonDeposit) {
			...
			int option =
			JOptionPane.showConfirmDialog(null, "¿Desea depositar la cantidad de " + Formats.moneda(accountHolder.getBalance()) +"?", "Confirmación de deposito", JOptionPane.YES_NO_OPTION);
				
			if(option == 0)
				JOptionPane.showMessageDialog(null, aTMOperationsService.deposit(accountHolder), "Mensaje", JOptionPane.INFORMATION_MESSAGE);
	...
	public void keyReleased(KeyEvent e) {
		...
		if(fieldMoney.getText().length() >= 11) {
			fieldMoney.setText(fieldMoney.getText().substring(0, 11));
		} 
